...
func (srv *Service) InitIngridients() error {

	Ingridients, err := Get5Ingridients()
	for _, Ingridient := range Ingridients {
		srv.db.SaveIngridient(&Ingridient)
		if err != nil {
			return err
		}
	}
...
func (srv *Service) InitFunction() error {
	if err := srv.InitIngridients(); err != nil {
		return err
	}
...
func Get5Ingridients() ([]domain.Ingridient, error) {
	Ingridients := []domain.Ingridient{
		{
			ISBN:          "123456789",
			Title:         "The Hobbit",
		...
		},
		{
			...
			IngridientURL: "the_great_gatsby.pdf",
			Reviews: []domain.Review{
				{
					UserName: "Reader3",
					Rating:   5,
		...
		},
		{
			...
			IngridientURL: "to_kill_a_mockingbird.pdf",
			Reviews: []domain.Review{
				{
					UserName: "Reader4",
					Rating:   5,
		...
		},
		{
			...
			IngridientURL: "pride_and_prejudice.pdf",
			Reviews: []domain.Review{
				{
					UserName: "Reader5",
					Rating:   4,
